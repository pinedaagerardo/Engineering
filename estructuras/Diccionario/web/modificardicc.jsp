<%-- 
    Document   : modificardicc
    Created on : 2/05/2008, 11:45:15 AM
    Author     : gerardo
--%>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="content">
                <div id="right">
                    <br><br><br>
                        <form method="post" action="modidicc.jsp">
                            Palabra a modificar: <input type="text" name="pvieja"><br><br>
                            Nombre nuevo: <input type="text" name="pnueva"><br><br>
