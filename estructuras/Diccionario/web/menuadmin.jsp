<%-- 
    Document   : menuadmin
    Created on : 2/05/2008, 07:38:12 AM
    Author     : gerardo
--%>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="content">
                <div id="right">
                    <br><br><br>
                        <form method="post" action="bloqueos.jsp">
                            <input type="hidden" name="action" value="block">
                            Bloquear un usuario: <input type="text" name="usuario">
                            <input type="submit" value="Bloquear">
                        </form>
                        <br><br>
                        <form method="post" action="bloqueos.jsp">
                            <input type="hidden" name="action" value="un">
                            Desbloquear un usuario: <input type="text" name="usuario">
                            <input type="submit" value="Desbloquear">
                        </form>
                        <br><br>
                        <form method="post" action="estadous.jsp">
                            Estado (h ó b ó *): <input type="text" name="state">
                            <input type="submit" value="Estado de usuarios">
                        </form>    
                        <br><br><br>
                    <!-- footer begins -->
                    <div id="metamorph1">
