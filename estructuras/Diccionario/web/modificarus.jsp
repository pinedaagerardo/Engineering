<%-- 
    Document   : modificarus
    Created on : 2/05/2008, 12:29:30 PM
    Author     : gerardo
--%>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="content">
                <div id="right">
                    <br><br><br>
                        <form method="post" action="modius.jsp">
                            Usuario a modificar: <input type="text" name="vusuario"><br><br>
                            Usuario nuevo: <input type="text" name="nusuario"><br><br>
                            Clave nueva: <input type="text" name="nclave"><br><br>
